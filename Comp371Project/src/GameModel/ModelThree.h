...
class ModelThree : public GameModel
{
public:

	ModelThree(std::shared_ptr<Transform> worldTransform) : GameModel(worldTransform)
	{
...
private:
	...
	void SetModelCubesTransform()
	{
		...
		m_cubeModel[2]->position = { -2, 0,  0 };
		m_cubeModel[3]->position = { -1,  -1,  0 };
		m_cubeModel[4]->position = { 0,  1,  0 };
		m_cubeModel[5]->position = { 1,  0,  0 };
		m_cubeModel[6]->position = { 1,  1,  0 };
		m_cubeModel[7]->position = { 2, 0,  0 };
		m_cubeModel[8]->position = { 2, 1,  0 };
		m_cubeModel[9]->position = { 2, -1,  0 };
		m_cubeModel[10]->position = { 0,  0, -1 };
		m_cubeModel[11]->position = { -1, -1, -1 };
		m_cubeModel[12]->position = { 0,  1, -1 };
